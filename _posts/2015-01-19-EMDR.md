...
excerpt: "….EMDR, Adaptif Bilgi İşleme Modeli’nin rehberlik ettiği bir tedavi yaklaşımıdır. Bu yaklaşıma göre duygu yükü çok fazla olan ve bu yüzden izole olarak depolanmış anılar, psikolojik sorunların ortaya çıkma sebebidir. Bu anıların işlenmesi ve daha büyük anı ağlarıyla bağlantılandırılmasıyla iyileşme sağlanır…"
